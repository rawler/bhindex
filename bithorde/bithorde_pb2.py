...
_HANDSHAKECONFIRMED = _descriptor.Descriptor(
...
_BINDREAD = _descriptor.Descriptor(
  name='BindRead',
...
_BINDWRITE = _descriptor.Descriptor(
  name='BindWrite',
...
_ASSETSTATUS = _descriptor.Descriptor(
  name='AssetStatus',
...
_READ_REQUEST = _descriptor.Descriptor(
  name='Request',
...
_READ_RESPONSE = _descriptor.Descriptor(
  name='Response',
...
HandShakeConfirmed = _reflection.GeneratedProtocolMessageType('HandShakeConfirmed', (_message.Message,), dict(
  DESCRIPTOR = _HANDSHAKECONFIRMED,
  __module__ = 'bithorde_pb2'
  # @@protoc_insertion_point(class_scope:bithorde.HandShakeConfirmed)
  ))
_sym_db.RegisterMessage(HandShakeConfirmed)

BindRead = _reflection.GeneratedProtocolMessageType('BindRead', (_message.Message,), dict(
  DESCRIPTOR = _BINDREAD,
  __module__ = 'bithorde_pb2'
  # @@protoc_insertion_point(class_scope:bithorde.BindRead)
  ))
_sym_db.RegisterMessage(BindRead)

BindWrite = _reflection.GeneratedProtocolMessageType('BindWrite', (_message.Message,), dict(
  DESCRIPTOR = _BINDWRITE,
  __module__ = 'bithorde_pb2'
  # @@protoc_insertion_point(class_scope:bithorde.BindWrite)
  ))
_sym_db.RegisterMessage(BindWrite)

AssetStatus = _reflection.GeneratedProtocolMessageType('AssetStatus', (_message.Message,), dict(
...
_sym_db.RegisterMessage(Read.Request)
_sym_db.RegisterMessage(Read.Response)
